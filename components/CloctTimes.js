...
export default function ClockInTable() {
  ...
  if (loading) {
    return <div className="flex justify-center items-center p-[150px]">Loading...</div>; // Loading indicator
  }
  ...
  return (
    <div className="overflow-x-auto mb-20">
      ...
      <button onClick={handleDownloadPDF} className=" flex items-center justify-center py-2  bg-green_1 w-full ">
       <div className="font-semibold pr-2">Download TimeSheet</div> <FaDownload />
      </button>
    </div>
  );
}
